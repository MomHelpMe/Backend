...
import { closeAllSockets } from "../core/showLoading.js";
...
export class Menu extends Component {
  ...
  mounted() {
    new List(document.querySelector("ul#gameMenu"), {
      className: "gameMode",
      ids: ["LocalGame", "MultiGame", "Tournament"],
      contents: this.translations.gameMenuTexts,
    });
    new List(document.querySelector("ul#userMenu"), {
      className: "showInfo",
      ids: ["Friends", "Profile", "Logout"],
      contents: this.translations.userMenuTexts,
    });
  }
