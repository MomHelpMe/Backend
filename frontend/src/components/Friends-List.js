...
export class FriendsList extends Component {
  ...
  mounted() {
    // API !!! Friends GET
    fetch("https://localhost/api/friends/", {
      method: "GET",
      ...
      .then((data) => {
        ...
        const friendNicknameList = this.friends.map(
  ...
  setEvent() {
    this.addEvent("click", ".fList", (event) => {
      ...
      this.info = new FriendsInfo(ulElement, {
        is_online: friend.is_online,
        nickname: `${friend.nickname}#${friend.user_id}`,
        img_url: friend.img_url,
        profileText: this.translations.profileText,
        removeText: this.translations.removeText,
      });
    ...
    this.addEvent("click", "#addFriend", (event) => {
      ...
      this.search = new Input(ulElement, {
        inputId: "searchInput",
        imageId: "addInputImage",
        img: "/img/plus.jpeg",
        searchText: this.translations.searchText,
      });
    ...
    this.addEvent("click", "#addInputImage", () => {
      addInput.call(this);
    });
      ...
      fetch("https://localhost/api/user/", {
        ...
        .then((data) => {
          ...
          const filteredUsers = this.users.filter((user) =>
            user.nickname.toLowerCase().startsWith(query)
          );
