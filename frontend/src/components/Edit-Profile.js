...
export class EditProfile extends Component {
  translate() {
    ...
    if (parseInt(this.props.uid) !== payload.id) changeUrl("/404", false);
    ...
    const languages = {
      0: {
        ...
        deleteMsgText2:
          "If you delete your account, all your information and related data will be permanently removed.",
        deleteMsgText3:
          "This action cannot be undone, and the deleted data cannot be recovered.",
        deleteMsgText4:
          "If you agree to delete your account and all related data, please select the checkbox below and click the 'Yes' button.",
        yesText: "Yes",
        noText: "No",
      },
      1: {
        ...
        deleteMsgText2:
          "회원 탈퇴를 진행하시면, 귀하의 모든 계정 정보와 관련된 데이터가 영구적으로 삭제됩니다.",
        deleteMsgText3:
          "이 작업은 되돌릴 수 없으며, 삭제된 데이터는 복구할 수 없습니다.",
        deleteMsgText4:
          "회원 탈퇴와 데이터 삭제에 동의하시면 아래의 확인란을 선택하고 '예' 버튼을 눌러 주십시오.",
        yesText: "예",
        noText: "아니요",
      },
      2: {
        ...
        deleteMsgText2:
          "アカウントを削除すると、すべてのアカウント情報と関連データが永久に削除されます。",
        deleteMsgText3:
          "この操作は元に戻すことができず、削除されたデータは復元できません。",
        deleteMsgText4:
          "アカウントと関連データの削除に同意する場合は、以下のチェックボックスを選択し、「はい」ボタンをクリックしてください。",
        yesText: "はい",
        noText: "いいえ",
      },
    };
			...
			<div id="edit-box">
					...
					<div id="prevProfile">
						...
						<div id="edit-img">
							...
							<div id="url-upload-wrapper">
								...
								<input type="text" autocomplete="off" class="profile-image-url" value="${
                  this.state.img_url
                ...
                this.state.nickname
						...
						<div class="edit" id="edit-img">
							...
							<div id="url-upload-wrapper">
								<label for="image-url">${translations.urlText}</label>
								<input type="text" autocomplete="off" class="profile-image-url" id="image-url" value="${
                  this.state.img_url
